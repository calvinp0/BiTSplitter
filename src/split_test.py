...
"""
        ...
        adjlist = split.get_adjlist_from_dmat(
            dmat=ts_dmat, symbols=symbols, h=4, a=7, b=2
        )
        self.assertEqual(
            adjlist,
            {
        ...
        adjlist = split.get_adjlist_from_dmat(
            dmat=dmat, symbols=xyz_dict["symbols"], h=11, a=7, b=10
        )
        self.assertEqual(
            adjlist,
            {
    ...
    def test_get_group_xyzs_and_key_indices_from_ts_xyz(self):
        ...
        g1_xyz, g2_xyz, index_dict = split.get_group_xyzs_and_key_indices_from_ts(
            xyz=xyz_dict, a=a, b=b, h=h
        )

        self.assertEqual(
            g1_xyz,
            {
                "symbols": ("C", "H", "H", "H", "C", "H", "H", "C", "H", "H", "H"),
                "isotopes": (12, 1, 1, 1, 12, 1, 1, 12, 1, 1, 1),
                "coords": (
                    (-0.8964723656188727, 0.21067833990016682, -0.9177560488779365),
                    (-0.8462422656188724, -0.7516324800998332, -1.3828584988779364),
                    (-0.3378268956188726, 0.9161822099001669, -1.4966073288779365),
                    (-1.9173434856188725, 0.5258444999001668, -0.8595788988779365),
                    (-0.30350430561887265, 0.12669006990016674, 0.5010233311220635),
                    (-0.3537353656188724, 1.0890064699001667, 0.9661202511220635),
                    (-0.8621437356188726, -0.5788175600998332, 1.0798825711220637),
                    (1.1657966543811276, -0.3269136300998332, 0.41727923112206344),
                    (1.7244327943811275, 0.3785800499001668, -0.16159960887793645),
                    (1.2160208543811275, -1.2892419800998332, -0.047797498877936495),
                    (1.7838137043811275, -0.4144044800998332, 1.8959317711220633),
                ),
            },
        )
        self.assertEqual(
            g2_xyz,
            {
                ...
                "isotopes": (16, 1, 16, 1),
                "coords": (
                    (-0.5173834992814444, -0.40621114930172336, 0.010148088176216596),
                    (-1.0720189592814444, -0.32786034930172336, -1.316450871823784),
                    (0.5105819507185555, 0.41625393069827665, 0.1065376381762162),
                    (1.1799644707185555, 0.1684741206982766, -0.5354362818237837),
                ),
            },
        )
